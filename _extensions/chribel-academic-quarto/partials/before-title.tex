...
% Depending on the type of document, mostly summaries, I remove the spacing
% Display-styled Equations insert, since it's a waste of space.
...
\titleformat
  ...
  {\thesection} % {⟨label⟩}
  {3mm} % {⟨sep⟩}
  {#1\hspace{2mm}\xrfill[0.6ex]{1pt}} % {⟨before-code⟩}
